...
particle dust{color:[1.0,1.0,1.0],scale:2} ^ ^2 ^ 0 0 0 0 2 force
particle dust{color:[1.0,1.0,1.0],scale:2} ^0.5 ^1.5 ^ 0 0 0 0 2 force
particle dust{color:[1.0,1.0,1.0],scale:2} ^1 ^1 ^ 0 0 0 0 2 force
particle dust{color:[1.0,1.0,1.0],scale:2} ^0.5 ^0.5 ^ 0 0 0 0 2 force
particle dust{color:[1.0,1.0,1.0],scale:2} ^ ^ ^ 0 0 0 0 2 force
particle dust{color:[1.0,1.0,1.0],scale:2} ^-0.5 ^0.5 ^ 0 0 0 0 2 force
particle dust{color:[1.0,1.0,1.0],scale:2} ^-1 ^1 ^ 0 0 0 0 2 force
particle dust{color:[1.0,1.0,1.0],scale:2} ^-0.5 ^1.5 ^ 0 0 0 0 2 force
...
execute if score @s tp_distacne matches 1.. at @s run function neifours:magic/magicstick/tp/markerforsssstp
