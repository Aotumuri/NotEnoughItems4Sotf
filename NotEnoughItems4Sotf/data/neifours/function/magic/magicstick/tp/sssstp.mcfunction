...
execute as @s[tag=magic_power] run effect give @s speed 32 2
execute as @s[tag=magic_power] run effect give @s regeneration 10 2
execute as @s[tag=magic_power] run effect give @s resistance 5 9
#後ろ処理
#tagを消すだけ
#あと必要MPもここから変えてね！
