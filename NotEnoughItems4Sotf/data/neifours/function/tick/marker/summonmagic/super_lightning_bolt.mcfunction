...
execute if score @s Neifours.Cooldown.Summonmagic.Circle matches 20.. run function neifours:utilities/particle/makecircleline {particle:"dust{color:[0.0,0.64,0.63],scale:3}",scale:3}
execute if score @s Neifours.Cooldown.Summonmagic.Circle matches 20.. run scoreboard players set @s Neifours.Cooldown.Summonmagic.Circle 0
