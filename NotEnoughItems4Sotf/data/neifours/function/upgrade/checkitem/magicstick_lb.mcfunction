...
#give!!!
execute as @s[tag=item_counter,tag=enough_item] run function neifours:upgrade/giveitem/magicstick_slb
execute as @s[tag=item_counter,tag=enough_item] run clear @s copper_ingot 32
