...
execute as @p store result score @s itemschecker run clear @s minecraft:ender_pearl 10
#clear!
...
#give!!!
execute as @s[tag=item_counter,tag=enough_item] run function neifours:upgrade/giveitem/magicstick_stp
execute as @s[tag=item_counter,tag=enough_item] run clear @s minecraft:ender_pearl 10
