...
#magicstick_lb
execute as @s if entity @s[nbt={Inventory:[{Slot:0b,components:{"minecraft:custom_data":{MagicStick_LB:True}}}]}] run function neifours:upgrade/checkitem/magicstick_lb