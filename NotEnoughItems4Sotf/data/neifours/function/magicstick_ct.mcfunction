...
execute as @p store result score @s sr_items run clear @s minecraft:splash_potion[custom_data={MagicPot:true}] 0
execute as @s[tag=magic_pot_counter] if score @s sr_items matches 1.. run tag @s add magic_power
execute as @s[tag=magic_pot_counter,tag=!magic_power] run function neifours:needmoremp
