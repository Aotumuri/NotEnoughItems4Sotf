...
#ultra_super_lightning_bolt (uslb_1)
execute as @s at @s if entity @s[tag=Neifours.Throw.Tag.uslb_1] run particle dust{color:[0.68,1.0,1.0],scale:1} ~ ~1 ~ 0.1 0.1 0.1 0 2 force
execute as @s at @s if entity @s[tag=Neifours.Throw.Tag.uslb_1] run particle dust{color:[1.0,1.0,1.0],scale:2} ~ ~1 ~ 0.5 0.5 0.5 0 2 force
...
#super_lightning_bolt (slb_1)
execute as @s at @s if entity @s[tag=Neifours.Throw.Tag.slb_1] run particle dust{color:[0.68,1.0,1.0],scale:1} ~ ~1 ~ 0.1 0.1 0.1 0 2 force
