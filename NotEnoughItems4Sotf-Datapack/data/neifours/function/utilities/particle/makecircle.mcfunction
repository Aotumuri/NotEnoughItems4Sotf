...
execute as @e[type=marker,tag=markerfourmakecircle,sort=nearest,limit=1] run execute if data storage neifours:particlesetting {particleAmount:2} run scoreboard players set @s utilities_circle 45
