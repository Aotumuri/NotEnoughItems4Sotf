...
execute if data storage neifours:setting {particleAmount:0} run execute rotated as @s run tp @s ~ ~ ~ ~1 ~
execute if data storage neifours:setting {particleAmount:1} run execute rotated as @s run tp @s ~ ~ ~ ~2 ~
execute if data storage neifours:setting {particleAmount:2} run execute rotated as @s run tp @s ~ ~ ~ ~8 ~
