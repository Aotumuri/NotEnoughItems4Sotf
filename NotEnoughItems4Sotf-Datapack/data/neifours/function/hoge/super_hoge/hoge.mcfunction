...
scoreboard players set @s Neifours.hoge.superhoge.hoge.count.slb 10
scoreboard players set @s Neifours.hoge.superhoge.hoge.count.water_wave 3
scoreboard players set @s Neifours.hoge.superhoge.hoge.count.aotumuri_1 3




function neifours:hoge/super_hoge/hogehoge
function neifours:hoge/super_hoge/hogehogehoge