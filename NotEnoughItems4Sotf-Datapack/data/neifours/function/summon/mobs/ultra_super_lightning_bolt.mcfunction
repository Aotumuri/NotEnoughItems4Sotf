...
execute if data storage neifours:setting {particleAmount:2} run particle minecraft:campfire_signal_smoke ~ ~ ~ 0 0 0 0.02 10 force
execute if data storage neifours:setting {particleAmount:0} run particle dust{color:[0.68,1.0,1.0],scale:1} ~ ~1 ~ 3 3 3 1 250 force
execute if data storage neifours:setting {particleAmount:1} run particle dust{color:[0.68,1.0,1.0],scale:1} ~ ~1 ~ 3 3 3 1 150 force
execute if data storage neifours:setting {particleAmount:2} run particle dust{color:[0.68,1.0,1.0],scale:1} ~ ~1 ~ 3 3 3 1 25 force
