...
execute as @e[type=marker,tag=AotumuriRing_1,sort=nearest,limit=1] run scoreboard players set @s Neifours.marker.AotumuriRing.Time.Count 1200
...
execute as @e[type=marker,tag=AotumuriRing_2,sort=nearest,limit=1] run scoreboard players set @s Neifours.marker.AotumuriRing.Time.Count 1200
...
execute as @e[type=marker,tag=AotumuriRing_3,sort=nearest,limit=1] run scoreboard players set @s Neifours.marker.AotumuriRing.Time.Count 1200
...
execute as @e[type=marker,tag=AotumuriRing_4,sort=nearest,limit=1] run scoreboard players set @s Neifours.marker.AotumuriRing.Time.Count 1200
weather thunder 5d