...
scoreboard objectives add Neifours.hoge.superhoge.hoge.count.uslb_1 dummy
...
execute as @e[tag=Neifours.tag.mobs.Aotumuri] at @s if score @s Neifours.tag.mobs.Aotumuri.Cooldown matches 4.. run function neifours:tick/tag/aotumuri/count
