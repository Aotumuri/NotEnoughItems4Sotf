execute if score @s Neifours.score.mobs.Aotumuri.random matches 30..35 run scoreboard players set @s Neifours.hoge.superhoge.hoge.count.uslb_1 10
execute if score @s Neifours.score.mobs.Aotumuri.random matches 36..40 run scoreboard players set @s Neifours.hoge.superhoge.hoge.count.slb_1 10
