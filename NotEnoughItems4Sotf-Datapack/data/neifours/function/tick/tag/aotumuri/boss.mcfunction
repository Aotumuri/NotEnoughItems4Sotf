...
execute if score @s Neifours.score.mobs.Aotumuri.damageTaken.count matches 20 run function neifours:summon/marker/water_wave
execute if score @s Neifours.score.mobs.Aotumuri.damageTaken.count matches 20 run scoreboard players set @s Neifours.score.mobs.Aotumuri.damageTaken.count 0
