#neifours:tick/marker/summonmagic/super_lightning_bolt
execute as @s at @s if entity @s[tag=marker_summon_super_lightning_bolt] run function neifours:tick/marker/summonmagic/super_lightning_bolt
#neifours:tick/marker/summonmagic/ultra_super_lightning_bolt
