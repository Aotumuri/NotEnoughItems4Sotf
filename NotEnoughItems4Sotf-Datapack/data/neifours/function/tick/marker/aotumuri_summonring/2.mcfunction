...
execute as @s at @s if score @s Neifours.marker.AotumuriRing.Count matches 2 run execute if data storage neifours:setting {particleAmount:0} run function neifours:tick/marker/aotumuri_summonring/2_1
execute as @s at @s if score @s Neifours.marker.AotumuriRing.Count matches 2 run execute if data storage neifours:setting {particleAmount:1} run function neifours:tick/marker/aotumuri_summonring/2_2
execute as @s at @s if score @s Neifours.marker.AotumuriRing.Count matches 2 run execute if data storage neifours:setting {particleAmount:2} run function neifours:tick/marker/aotumuri_summonring/2_2
